...
export default function ReportPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 print:bg-white">
      ...
      {/* Report Content */}
      <div className="p-8 print:p-0 flex flex-col items-center space-y-8 print:space-y-0 print:block">
        ...
        <div className="flex border-b-[0.5px] border-black h-8">
          ...
          <div className="flex-1 flex items-center justify-center">
            <input 
              ...
              className="w-full h-full text-center bg-transparent outline-none px-1 text-xs font-mono"
